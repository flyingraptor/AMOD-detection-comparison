"""Train YOLO11-OBB on the AMOD dataset.

Usage:
    python train_yolo11_obb.py [--model yolo11s-obb] [--epochs 30] [--batch 4]
"""
...
WORK_DIR  = str(Path(__file__).parent.parent / "runs" / "yolo_obb" / "yolo11s_baseline")
